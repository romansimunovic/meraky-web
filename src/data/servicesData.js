export const servicesData = [
  ...
  {
    category: "Pedikura i estetika stopala",
  ...
  {
    category: "Rituali glatkoće",
    subtitle: "Dugotrajna svilenkasta mekoća prilagođena i najosjetljivijoj koži",
    icon: "smooth",
    items: [
      { name: "Bezbolna depilacija cijelih nogu", price: 25, duration: "30 min" },
      { name: "Depilacija ruku i pazuha", price: 15, duration: "20 min" },
      { name: "Precizno oblikovanje obrva koncem", price: 10, duration: "15 min" }
    ]
  }
];